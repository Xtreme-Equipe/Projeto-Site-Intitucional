...
<body>
    ...
    <nav>
        <div class="center">
            ...
            <ul class="menu">
                ...
                <li><a class="btn-menu" href="../Projetos/projetos.html">Projetos</a></li>
    ...
    <div class="cadastro_projetos">
        ...
        <br>
        <form class="formulario" method = "post" action="cadastrado_com_sucesso_projeto.html"> <!--Em um form so aceita uma action e entao sera enviado para cadstro_concluido e de la salvara as informaçoes no banco de dados, por isso teria que ter uma pagina para cada cadastro-->
